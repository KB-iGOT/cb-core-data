...
DEFAULT_CONFIG = {
    ...
    'mlReportPath': 'pyspark/standalone-reports/ml-report',
    ...
    # Report Paths
    'userReportPath': 'pyspark/standalone-reports/user-report',
    'userEnrolmentReportPath': 'pyspark/standalone-reports/user-enrollment-report',
    'courseReportPath': 'pyspark/standalone-reports/course-report',
    'cbaReportPath': 'pyspark/standalone-reports/cba-report',
    'taggedUsersPath': 'tagged-users/',
    'standaloneAssessmentReportPath': 'pyspark/standalone-reports/user-assessment-report-cbp',
    'blendedReportPath': 'pyspark/standalone-reports/blended-program-report',
    'orgHierarchyReportPath': 'pyspark/standalone-reports/org-hierarchy-report',
    'acbpReportPath': 'pyspark/standalone-reports/cbp-report',
    'acbpMdoEnrolmentReportPath': 'pyspark/standalone-reports/cbp-report-mdo-enrolment',
    'acbpMdoSummaryReportPath': 'pyspark/standalone-reports/cbp-report-mdo-summary',
    'kcmReportPath': 'pyspark/standalone-reports/kcm-report',
    'commsConsoleReportPath': 'pyspark/standalone-reports/comms-console',
    'validationReportPath': 'pyspark/standalone-reports/validation-report',
    ...
    'destinationDirectoryPath': 'pyspark/standalone-reports/merged',
    ...
    'mdoReportSyncPath': 'pyspark/standalone-reports/pyspark/',
    'fullReportSyncPath': 'pyspark/standalone-reports/pyspark/fullReport/',
    'kcmSyncPath': 'pyspark/standalone-reports/pyspark/kcm/',
