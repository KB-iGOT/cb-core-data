...
class UserAssessmentModel:    
    ...
    def process_report(self,spark,config):
        ...
        try:
            ...
            # Export report
            dfexportutil.write_csv_per_mdo_id(original_df, f"{config.localReportDir}/{config.standaloneAssessmentReportPath}/{today}", 'mdoid', csv_filename="StandaloneAssessmentReport.csv")
