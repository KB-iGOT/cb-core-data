...
DATABASE_CONFIG = {
    ...
    'app_postgres_username': '{{ app_postgres_username }}',
    'app_postgres_credential': '{{ app_postgres_password }}',
...
SPARK_CONFIG = {
    ...
    'cassandra_host': '{{ sparkCassandraConnectionHost }}',
    'cassandra_port': '{{ sparkCassandraConnectionPort }}',
